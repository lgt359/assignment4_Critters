...
public abstract class Critter {
	...
	/** Moves critter two spot in given direction, 0-7.
	 *  Deducts energy cost from critter's current energy state.
	 * @param direction
	 */
	...
	/** Checks if critter's run away position is occupied by another critter.
	 * Critter always runs away towards the right (direction:0)
	 * If occupied, critter can not run away.
	 * If not occupied, critter runs away
	 */
	...
	/** Adds new offspring to world
	 * @param offspring New critter that we are adding
	 * @param direction The direction where we place critter in reference to parent's position
	 */
	...
	/**
	 * Display current frame of 2-D simulated world
	 */
	...
	/**
	 * Print middle section of frame.
	 * Consists of critters printed at corresponding coordinates
	 * Prints " " if no critter lies in a coordinate
	 */
